...
-- Date        : Wed Jun 24 17:14:06 2020
-- Host        : yl running 64-bit Ubuntu 18.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top axi_bd_util_ds_buf_0_0 -prefix
--               axi_bd_util_ds_buf_0_0_ axi_bd_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : axi_bd_util_ds_buf_0_0
...
entity axi_bd_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of axi_bd_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of axi_bd_util_ds_buf_0_0_util_ds_buf : entity is "ibufdsgte2";
  attribute C_SIZE : integer;
  attribute C_SIZE of axi_bd_util_ds_buf_0_0_util_ds_buf : entity is 1;
end axi_bd_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of axi_bd_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axi_bd_util_ds_buf_0_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of axi_bd_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi_bd_util_ds_buf_0_0 : entity is "axi_bd_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of axi_bd_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of axi_bd_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2018.3";
end axi_bd_util_ds_buf_0_0;

architecture STRUCTURE of axi_bd_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, CLK_DOMAIN axi_bd_util_ds_buf_0_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, CLK_DOMAIN axi_bd_util_ds_buf_0_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.axi_bd_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
